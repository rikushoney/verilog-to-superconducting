...
#line 362 "verilog_parser.y"

#include "frontends/verilog/verilog_frontend.h"
#include <map>
#include <string>

#line 63 "verilog_parser.tab.hh"
...
/* Value type.  */
#if !defined FRONTEND_VERILOG_YYSTYPE &&                                       \
    !defined FRONTEND_VERILOG_YYSTYPE_IS_DECLARED
union FRONTEND_VERILOG_YYSTYPE {
#line 368 "verilog_parser.y"

  std::string *string;
  struct YOSYS_NAMESPACE_PREFIX AST::AstNode *ast;
  YOSYS_NAMESPACE_PREFIX dict<YOSYS_NAMESPACE_PREFIX RTLIL::IdString,
                              YOSYS_NAMESPACE_PREFIX AST::AstNode *> *al;
...
#line 240 "verilog_parser.tab.hh"
};
...
/* Location type.  */
#if !defined FRONTEND_VERILOG_YYLTYPE &&                                       \
    !defined FRONTEND_VERILOG_YYLTYPE_IS_DECLARED
