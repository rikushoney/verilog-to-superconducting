...
impl<'a> Command<'a> {
    ...
    >(
        ...
        alt((
            ...
            map(unsupported::FsmDescription::parse, Command::FsmDescription),
            map(
                unsupported::ClockConstraint::parse,
                Command::ClockConstraint,
            ),
            map(
                unsupported::DelayConstraint::parse,
                Command::DelayConstraint,
            ),
        ))(input)
    }
}
